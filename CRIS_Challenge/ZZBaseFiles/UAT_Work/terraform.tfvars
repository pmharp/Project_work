...
TFVAR_requestedfor          = "PRIMSID"               # Leave off the @ms.ds.uhc.com
TFVAR_askid                 = "UHGWM110-020897"       # example UHGWM110-020897
TFVAR_targetenv             = "TEST"                  # Options are DEV, TEST, STAGE, PROD"
TFVAR_datacenter            = "ELR"                   # Options are CTC or ELR"
...
TFVAR_vradescription        = "UAT Destroy when done" # Used across all TF files
...
TFVAR_odi_askid               = "UHGWM110-020897"  # example UHGWM110-020897
...
TFVAR_odi_sharedaccessgroup   = "IaC_Architecture" # AD group used to manage VM resources and ownership
