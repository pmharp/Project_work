...
function RDTIN1{
    Set-Location -Path "E:\SC\Rightfax-Kiosk\SANDBOX\BAI-IN3\RDT\"
    clear-host
    Invoke-expression -Command "E:\SC\Rightfax-Kiosk\Sandbox\BAI-IN3\RDT\BAIRDTIN.PS1 -Credential $Cred"
    Start_Menu($select)
}

function APPIN1{
    Set-Location -Path "E:\SC\Rightfax-Kiosk\SANDBOX\BAI-IN3\APP\"
    clear-host
    Invoke-expression -Command "E:\SC\Rightfax-Kiosk\Sandbox\BAI-IN3\APP\BAIAPPIN.PS1 -Credential $Cred"
    Start_Menu($select)
}

function TaskIN1{
    Set-Location -Path "E:\SC\Rightfax-Kiosk\SANDBOX\BAI-IN3\Task\"
    clear-host
    Invoke-expression -Command "E:\SC\Rightfax-Kiosk\Sandbox\BAI-IN3\Task\BAITASKIN.PS1 -Credential $Cred"
    Start_Menu($select)
}

function WebIN1{
    Set-Location -Path "E:\SC\Rightfax-Kiosk\SANDBOX\BAI-IN3\Web\"
    clear-host
    Invoke-expression -Command "E:\SC\Rightfax-Kiosk\Sandbox\BAI-IN3\Web\BAIWebIN.PS1 -Credential $Cred"
    Start_Menu($select)
}
function SQLIN1{
    Set-Location -Path "E:\SC\Rightfax-Kiosk\SANDBOX\BAI-IN3\SQL-AO\"
    clear-host
    Invoke-expression -Command "E:\SC\Rightfax-Kiosk\Sandbox\BAI-IN3\SQL-AO\BAISQLIN.PS1 -Credential $Cred"
    Start_Menu($select)
}
