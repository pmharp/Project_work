# -*- encoding: utf-8 -*-
# stub: knife-google 4.2.8 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<google-api-client>.freeze, [">= 0.23.9", "< 0.37.0"])
      s.add_runtime_dependency(%q<gcewinpass>.freeze, ["~> 1.1"])
    else
      s.add_dependency(%q<knife-cloud>.freeze, [">= 2.0.0"])
      s.add_dependency(%q<google-api-client>.freeze, [">= 0.23.9", "< 0.37.0"])
