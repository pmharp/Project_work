...
# Windows App Layer
# ------------------------------------------------------------------------------------------
TFVAR_windows_app_count  = "1"               # Number of Windows APP servers to build
...
TFVAR_windows_app_reason = "Windows Task Svr" # Value displayed in tech.optum.com / odi_getvmdetails utility
