...
resource "optumvm_windowsvm" "windows_odi_7" {
...
output "windows_odi_7_servername" {
  value = "${optumvm_windowsvm.windows_odi_7.servername}"
}

output "windows_odi_7_ipaddress" {
  value = "${optumvm_windowsvm.windows_odi_7.ipaddress}"
}

output "windows_odi_7_image_used" {
  value = "${optumvm_windowsvm.windows_odi_7.image}"
}

output "windows_odi_7_cpu" {
  value = "${optumvm_windowsvm.windows_odi_7.cpu}"
}

output "windows_odi_7_memory" {
  value = "${optumvm_windowsvm.windows_odi_7.memory}"
}

output "windows_odi_7_targetenv" {
  value = "${optumvm_windowsvm.windows_odi_7.targetenv}"
}

output "windows_odi_7_datacenter" {
  value = "${optumvm_windowsvm.windows_odi_7.datacenter}"
}

output "windows_odi_7_networkzone" {
  value = "${optumvm_windowsvm.windows_odi_7.networkzone}"
}
