...
function RDTA{
    Set-Location -Path "E:\SC\Rightfax-Kiosk\Stage\FAX-A\RDT\"
    clear-host
    Invoke-expression -Command "E:\SC\Rightfax-Kiosk\Stage\FAX-A\RDT\BAISRDTIN.PS1 -Credential $Cred"
    Start_Menu($select)
}

function APPA{
    Set-Location -Path "E:\SC\Rightfax-Kiosk\Stage\FAX-A\APP\"
    clear-host
    Invoke-expression -Command "E:\SC\Rightfax-Kiosk\Stage\FAX-A\APP\BAIAPPIN.PS1 -Credential $Cred"
    Start_Menu($select)
}

function TaskA{
    Set-Location -Path "E:\SC\Rightfax-Kiosk\Stage\FAX-A\Task\"
    clear-host
    Invoke-expression -Command "E:\SC\Rightfax-Kiosk\Stage\FAX-A\Task\BAITASKIN.PS1 -Credential $Cred"
    Start_Menu($select)
}

function WebA{
    Set-Location -Path "E:\SC\Rightfax-Kiosk\Stage\FAX-A\Web\"
    clear-host
    Invoke-expression -Command "E:\SC\Rightfax-Kiosk\Stage\FAX-A\Web\BAIWebIN.PS1 -Credential $Cred"
    Start_Menu($select)
}
function SQLA{
    Set-Location -Path "E:\SC\Rightfax-Kiosk\Stage\FAX-A\SQL-AO\"
    clear-host
    Invoke-expression -Command "E:\SC\Rightfax-Kiosk\Stage\FAX-A\SQL-AO\BAISQLIN.PS1 -Credential $Cred"
    Start_Menu($select)
}
