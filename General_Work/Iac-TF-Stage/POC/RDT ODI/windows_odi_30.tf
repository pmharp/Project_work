...
resource "optumvm_windowsvm" "windows_odi_30" {
...
output "windows_odi_30_servername" {
  value = "${optumvm_windowsvm.windows_odi_30.servername}"
}

output "windows_odi_30_ipaddress" {
  value = "${optumvm_windowsvm.windows_odi_30.ipaddress}"
}

output "windows_odi_30_image_used" {
  value = "${optumvm_windowsvm.windows_odi_30.image}"
}

output "windows_odi_30_cpu" {
  value = "${optumvm_windowsvm.windows_odi_30.cpu}"
}

output "windows_odi_30_memory" {
  value = "${optumvm_windowsvm.windows_odi_30.memory}"
}

output "windows_odi_30_targetenv" {
  value = "${optumvm_windowsvm.windows_odi_30.targetenv}"
}

output "windows_odi_30_datacenter" {
  value = "${optumvm_windowsvm.windows_odi_30.datacenter}"
}

output "windows_odi_30_networkzone" {
  value = "${optumvm_windowsvm.windows_odi_30.networkzone}"
}
