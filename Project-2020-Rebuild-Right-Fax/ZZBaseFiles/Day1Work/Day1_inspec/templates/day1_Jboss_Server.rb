...
title 'TF UAT JBOSS server settings'
...
# Day1 check for Jboss
control 'TF_OUTPUT_RESOURCE_NAME-JBoss' do
  impact 1.0
  title 'Check if JBoss is installed and confirm port'
  desc 'Check if JBoss is installed and confirm port'
