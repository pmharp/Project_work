...
resource "optumvm_windowsvm" "windows_odi_6" {
...
output "windows_odi_6_servername" {
  value = "${optumvm_windowsvm.windows_odi_6.servername}"
}

output "windows_odi_6_ipaddress" {
  value = "${optumvm_windowsvm.windows_odi_6.ipaddress}"
}

output "windows_odi_6_image_used" {
  value = "${optumvm_windowsvm.windows_odi_6.image}"
}

output "windows_odi_6_cpu" {
  value = "${optumvm_windowsvm.windows_odi_6.cpu}"
}

output "windows_odi_6_memory" {
  value = "${optumvm_windowsvm.windows_odi_6.memory}"
}

output "windows_odi_6_targetenv" {
  value = "${optumvm_windowsvm.windows_odi_6.targetenv}"
}

output "windows_odi_6_datacenter" {
  value = "${optumvm_windowsvm.windows_odi_6.datacenter}"
}

output "windows_odi_6_networkzone" {
  value = "${optumvm_windowsvm.windows_odi_6.networkzone}"
}
