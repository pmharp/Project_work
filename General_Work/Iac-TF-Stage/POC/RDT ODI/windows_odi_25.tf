...
resource "optumvm_windowsvm" "windows_odi_25" {
...
output "windows_odi_25_servername" {
  value = "${optumvm_windowsvm.windows_odi_25.servername}"
}

output "windows_odi_25_ipaddress" {
  value = "${optumvm_windowsvm.windows_odi_25.ipaddress}"
}

output "windows_odi_25_image_used" {
  value = "${optumvm_windowsvm.windows_odi_25.image}"
}

output "windows_odi_25_cpu" {
  value = "${optumvm_windowsvm.windows_odi_25.cpu}"
}

output "windows_odi_25_memory" {
  value = "${optumvm_windowsvm.windows_odi_25.memory}"
}

output "windows_odi_25_targetenv" {
  value = "${optumvm_windowsvm.windows_odi_25.targetenv}"
}

output "windows_odi_25_datacenter" {
  value = "${optumvm_windowsvm.windows_odi_25.datacenter}"
}

output "windows_odi_25_networkzone" {
  value = "${optumvm_windowsvm.windows_odi_25.networkzone}"
}
