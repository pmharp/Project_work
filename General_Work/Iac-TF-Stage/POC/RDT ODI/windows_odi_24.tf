...
resource "optumvm_windowsvm" "windows_odi_24" {
...
output "windows_odi_24_servername" {
  value = "${optumvm_windowsvm.windows_odi_24.servername}"
}

output "windows_odi_24_ipaddress" {
  value = "${optumvm_windowsvm.windows_odi_24.ipaddress}"
}

output "windows_odi_24_image_used" {
  value = "${optumvm_windowsvm.windows_odi_24.image}"
}

output "windows_odi_24_cpu" {
  value = "${optumvm_windowsvm.windows_odi_24.cpu}"
}

output "windows_odi_24_memory" {
  value = "${optumvm_windowsvm.windows_odi_24.memory}"
}

output "windows_odi_24_targetenv" {
  value = "${optumvm_windowsvm.windows_odi_24.targetenv}"
}

output "windows_odi_24_datacenter" {
  value = "${optumvm_windowsvm.windows_odi_24.datacenter}"
}

output "windows_odi_24_networkzone" {
  value = "${optumvm_windowsvm.windows_odi_24.networkzone}"
}
