...
TFVAR_odi_requestedfor         = "pharp"          # Leave off the @ms.ds.uhc.com
...
TFVAR_odi_privunixid           = "pharp101"   # Secondary UNIX ID: Able to login and has Admin Rights
TFVAR_odi_privuserunixgroup    = "dce"         # Unix Group able to login and has Admin Rights
TFVAR_odi_nonprivunixid        = "pharp101"   # Secondary UNIX ID: Able to login only - NO ADMIN rights
