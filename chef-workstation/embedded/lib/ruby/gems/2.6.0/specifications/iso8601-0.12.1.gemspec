...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<pry>.freeze, ["~> 0.11.0"])
      s.add_development_dependency(%q<pry-doc>.freeze, ["~> 0.13.4"])
    else
      s.add_dependency(%q<rspec>.freeze, ["~> 3.6"])
      s.add_dependency(%q<rubocop>.freeze, ["~> 0.50"])
      s.add_dependency(%q<pry>.freeze, ["~> 0.11.0"])
      s.add_dependency(%q<pry-doc>.freeze, ["~> 0.13.4"])
    end
  else
    s.add_dependency(%q<rspec>.freeze, ["~> 3.6"])
    s.add_dependency(%q<rubocop>.freeze, ["~> 0.50"])
