...
resource "optumvm_windowsvm" "windows_odi_31" {
...
output "windows_odi_31_servername" {
  value = "${optumvm_windowsvm.windows_odi_31.servername}"
}

output "windows_odi_31_ipaddress" {
  value = "${optumvm_windowsvm.windows_odi_31.ipaddress}"
}

output "windows_odi_31_image_used" {
  value = "${optumvm_windowsvm.windows_odi_31.image}"
}

output "windows_odi_31_cpu" {
  value = "${optumvm_windowsvm.windows_odi_31.cpu}"
}

output "windows_odi_31_memory" {
  value = "${optumvm_windowsvm.windows_odi_31.memory}"
}

output "windows_odi_31_targetenv" {
  value = "${optumvm_windowsvm.windows_odi_31.targetenv}"
}

output "windows_odi_31_datacenter" {
  value = "${optumvm_windowsvm.windows_odi_31.datacenter}"
}

output "windows_odi_31_networkzone" {
  value = "${optumvm_windowsvm.windows_odi_31.networkzone}"
}
