...
resource "optumvm_windowsvm" "windows_odi_19" {
...
output "windows_odi_19_servername" {
  value = "${optumvm_windowsvm.windows_odi_19.servername}"
}

output "windows_odi_19_ipaddress" {
  value = "${optumvm_windowsvm.windows_odi_19.ipaddress}"
}

output "windows_odi_19_image_used" {
  value = "${optumvm_windowsvm.windows_odi_19.image}"
}

output "windows_odi_19_cpu" {
  value = "${optumvm_windowsvm.windows_odi_19.cpu}"
}

output "windows_odi_19_memory" {
  value = "${optumvm_windowsvm.windows_odi_19.memory}"
}

output "windows_odi_19_targetenv" {
  value = "${optumvm_windowsvm.windows_odi_19.targetenv}"
}

output "windows_odi_19_datacenter" {
  value = "${optumvm_windowsvm.windows_odi_19.datacenter}"
}

output "windows_odi_19_networkzone" {
  value = "${optumvm_windowsvm.windows_odi_19.networkzone}"
}
