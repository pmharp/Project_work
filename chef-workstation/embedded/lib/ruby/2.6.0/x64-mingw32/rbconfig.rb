...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ".exe"
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "C:/opscode/chef-workstation/embedded")
  ...
  CONFIG["configure_args"] = " '--build=x86_64-w64-mingw32' '--prefix=C:/opscode/chef-workstation/embedded' '--without-ext=dbm,readline' '--enable-shared' '--disable-install-doc' '--without-gmp' '--without-gdbm' '--without-tk' '--disable-dtrace' '--disable-jit-support' 'debugflags=-g' 'build_alias=x86_64-w64-mingw32' 'CFLAGS=-IC:/opscode/chef-workstation/embedded/include -DFD_SETSIZE=2048 -m64 -march=x86-64 -O3' 'LDFLAGS=-LC:/opscode/chef-workstation/embedded/lib -m64 -fno-lto' 'CPPFLAGS=-IC:/opscode/chef-workstation/embedded/include -DFD_SETSIZE=2048 -m64 -march=x86-64 -O3' 'CXXFLAGS=-IC:/opscode/chef-workstation/embedded/include -DFD_SETSIZE=2048 -m64 -march=x86-64 -O3'"
  ...
  CONFIG["MAINLIBS"] = "-lshell32 -lws2_32 -liphlpapi -limagehlp -lshlwapi "
  ...
  CONFIG["DLDFLAGS"] = "-LC:/opscode/chef-workstation/embedded/lib -m64 -fno-lto -Wl,--enable-auto-image-base,--enable-auto-import $(DEFFILE)"
  CONFIG["ALLOCA"] = ""
  CONFIG["MATHN"] = "yes"
  CONFIG["dsymutil"] = ""
  CONFIG["codesign"] = ""
  ...
  CONFIG["try_header"] = ""
  CONFIG["CC_VERSION_MESSAGE"] = "gcc.exe (Rev3, Built by MSYS2 project) 9.1.0\nCopyright (C) 2019 Free Software Foundation, Inc.\nThis is free software; see the source for copying conditions.  There is NO\nwarranty; not even for MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE."
  ...
  CONFIG["CPP"] = "$(CC) -E"
  CONFIG["CXXFLAGS"] = "-IC:/opscode/chef-workstation/embedded/include -DFD_SETSIZE=2048 -march=x86-64 -O3"
  CONFIG["CXX"] = "g++"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-IC:/opscode/chef-workstation/embedded/include -DFD_SETSIZE=2048 -m64 -march=x86-64 -O3 -D_WIN32_WINNT=0x0600 -D__MINGW_USE_VC2005_COMPAT $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -LC:/opscode/chef-workstation/embedded/lib -fno-lto"
  CONFIG["CFLAGS"] = "-IC:/opscode/chef-workstation/embedded/include -DFD_SETSIZE=2048 -march=x86-64 -O3"
  CONFIG["CC"] = "gcc"
