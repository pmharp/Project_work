...
# Windows Web Layer
# ------------------------------------------------------------------------------------------
variable "TFVAR_windows_web_count"  { description = "Enter the server count" }
variable "TFVAR_windows_web_image"  { default ="" }
variable "TFVAR_windows_web_cpu"    { description = "Enter the CPU count" }
variable "TFVAR_windows_web_memory" { description = "Enter the RAM count" }
variable "TFVAR_windows_web_reason" { default ="" }

# ------------------------------------------------------------------------------------------
# Windows App Layer
# ------------------------------------------------------------------------------------------
variable "TFVAR_windows_app_count"  { description = "Enter the server count" }
variable "TFVAR_windows_app_image"  { default ="" }
variable "TFVAR_windows_app_cpu"    { description = "Enter the CPU count" }
variable "TFVAR_windows_app_memory" { description = "Enter the RAM count" }
