...
#TFVAR_windows_app_cpu    = "4"               # DAY2_MOD: Options are 1 - 16 using only EVEN numbers
#TFVAR_windows_app_memory = "8"              # DAY2_MOD: Options are 4 - 128 using only EVEN numbers
