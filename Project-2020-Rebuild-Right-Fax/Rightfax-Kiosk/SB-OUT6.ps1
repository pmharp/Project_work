...
function RDTIN1{
    Set-Location -Path "E:\SC\Rightfax-Kiosk\SANDBOX\BAI-OUT6\RDT\"
    clear-host
    Invoke-expression -Command "& .\BAIRDTOUT.PS1 -Credential $Cred"
    Start_Menu($select)
}

function APPIN1{
    Set-Location -Path "E:\SC\Rightfax-Kiosk\SANDBOX\BAI-OUT6\APP\"
    clear-host
    Invoke-expression -Command "E:\SC\Rightfax-Kiosk\Sandbox\BAI-OUT6\APP\BAIAPPOUT.PS1 -Credential $Cred"
    Start_Menu($select)
}

function TaskIN1{
    Set-Location -Path "E:\SC\Rightfax-Kiosk\SANDBOX\BAI-OUT6\Task\"
    clear-host
    Invoke-expression -Command "E:\SC\Rightfax-Kiosk\Sandbox\BAI-OUT6\Task\BAITASKOUT.PS1 -Credential $Cred"
    Start_Menu($select)
}

function WebIN1{
    Set-Location -Path "E:\SC\Rightfax-Kiosk\SANDBOX\BAI-OUT6\Web\"
    clear-host
    Invoke-expression -Command "E:\SC\Rightfax-Kiosk\Sandbox\BAI-OUT6\Web\BAIWebOUT.PS1 -Credential $Cred"
    Start_Menu($select)
}
function SQLIN1{
    Set-Location -Path "E:\SC\Rightfax-Kiosk\SANDBOX\BAI-OUT6\SQL-AO\"
    clear-host
    Invoke-expression -Command "E:\SC\Rightfax-Kiosk\Sandbox\BAI-OUT6\SQL-AO\BAISQLOUT.PS1 -Credential $Cred"
    Start_Menu($select)
}
