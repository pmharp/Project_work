...
resource "optumvm_windowsvm" "windows_odi_17" {
...
output "windows_odi_17_servername" {
  value = "${optumvm_windowsvm.windows_odi_17.servername}"
}

output "windows_odi_17_ipaddress" {
  value = "${optumvm_windowsvm.windows_odi_17.ipaddress}"
}

output "windows_odi_17_image_used" {
  value = "${optumvm_windowsvm.windows_odi_17.image}"
}

output "windows_odi_17_cpu" {
  value = "${optumvm_windowsvm.windows_odi_17.cpu}"
}

output "windows_odi_17_memory" {
  value = "${optumvm_windowsvm.windows_odi_17.memory}"
}

output "windows_odi_17_targetenv" {
  value = "${optumvm_windowsvm.windows_odi_17.targetenv}"
}

output "windows_odi_17_datacenter" {
  value = "${optumvm_windowsvm.windows_odi_17.datacenter}"
}

output "windows_odi_17_networkzone" {
  value = "${optumvm_windowsvm.windows_odi_17.networkzone}"
}
