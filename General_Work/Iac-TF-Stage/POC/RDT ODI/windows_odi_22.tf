...
resource "optumvm_windowsvm" "windows_odi_22" {
...
output "windows_odi_22_servername" {
  value = "${optumvm_windowsvm.windows_odi_22.servername}"
}

output "windows_odi_22_ipaddress" {
  value = "${optumvm_windowsvm.windows_odi_22.ipaddress}"
}

output "windows_odi_22_image_used" {
  value = "${optumvm_windowsvm.windows_odi_22.image}"
}

output "windows_odi_22_cpu" {
  value = "${optumvm_windowsvm.windows_odi_22.cpu}"
}

output "windows_odi_22_memory" {
  value = "${optumvm_windowsvm.windows_odi_22.memory}"
}

output "windows_odi_22_targetenv" {
  value = "${optumvm_windowsvm.windows_odi_22.targetenv}"
}

output "windows_odi_22_datacenter" {
  value = "${optumvm_windowsvm.windows_odi_22.datacenter}"
}

output "windows_odi_22_networkzone" {
  value = "${optumvm_windowsvm.windows_odi_22.networkzone}"
}
