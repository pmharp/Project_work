...
function RDTIN1{
    Set-Location -Path "E:\SC\Rightfax-Kiosk\SANDBOX\FAX-A\RDT\"
    clear-host
    Invoke-expression -Command "E:\SC\Rightfax-Kiosk\Sandbox\FAX-A\RDT\BAIRDTIN.PS1 -Credential $Cred"
    Start_Menu($select)
}

function APPIN1{
    Set-Location -Path "E:\SC\Rightfax-Kiosk\SANDBOX\FAX-A\APP\"
    clear-host
    Invoke-expression -Command "E:\SC\Rightfax-Kiosk\Sandbox\FAX-A\APP\BAIAPPIN.PS1 -Credential $Cred"
    Start_Menu($select)
}

function TaskIN1{
    Set-Location -Path "E:\SC\Rightfax-Kiosk\SANDBOX\FAX-A\Task\"
    clear-host
    Invoke-expression -Command "E:\SC\Rightfax-Kiosk\Sandbox\FAX-A\Task\BAITASKIN.PS1 -Credential $Cred"
    Start_Menu($select)
}

function WebIN1{
    Set-Location -Path "E:\SC\Rightfax-Kiosk\SANDBOX\FAX-A\Web\"
    clear-host
    Invoke-expression -Command "E:\SC\Rightfax-Kiosk\Sandbox\FAX-A\Web\BAIWebIN.PS1 -Credential $Cred"
    Start_Menu($select)
}
function SQLIN1{
    Set-Location -Path "E:\SC\Rightfax-Kiosk\SANDBOX\FAX-A\SQL-AO\"
    clear-host
    Invoke-expression -Command "E:\SC\Rightfax-Kiosk\Sandbox\FAX-A\SQL-AO\BAISQLIN.PS1 -Credential $Cred"
    Start_Menu($select)
}
