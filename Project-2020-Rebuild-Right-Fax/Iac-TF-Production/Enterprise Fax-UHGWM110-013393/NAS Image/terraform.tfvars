...
TFVAR_askid                 = "UHGWM110-013393"       # example UHGWM110-020897
...
TFVAR_drcode                = "DR-303"                # Options DR-000, DR-102, DR-111, DR-303 (DR-303 is Full_Support_Only)
TFVAR_drrto                 = "RTO-08"                # Options "" for DRs other than DR-303, If drcode="DR-303", then options are RTO-08,RTO-24,RTO-48,RTO-72
TFVAR_vradescription        = "Collective NAS Built"  # Shows in the vra gui when built
...
TFVAR_odi_askid               = "UHGWM110-013393" # example UHGWM110-020897
...
TFVAR_odi_requestedfor        = "arcsrvc"         # Leave off the @ms.ds.uhc.com
