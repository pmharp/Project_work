...
resource "optumvm_windowsvm" "windows_odi_16" {
...
output "windows_odi_16_servername" {
  value = "${optumvm_windowsvm.windows_odi_16.servername}"
}

output "windows_odi_16_ipaddress" {
  value = "${optumvm_windowsvm.windows_odi_16.ipaddress}"
}

output "windows_odi_16_image_used" {
  value = "${optumvm_windowsvm.windows_odi_16.image}"
}

output "windows_odi_16_cpu" {
  value = "${optumvm_windowsvm.windows_odi_16.cpu}"
}

output "windows_odi_16_memory" {
  value = "${optumvm_windowsvm.windows_odi_16.memory}"
}

output "windows_odi_16_targetenv" {
  value = "${optumvm_windowsvm.windows_odi_16.targetenv}"
}

output "windows_odi_16_datacenter" {
  value = "${optumvm_windowsvm.windows_odi_16.datacenter}"
}

output "windows_odi_16_networkzone" {
  value = "${optumvm_windowsvm.windows_odi_16.networkzone}"
}
