...
Invoke-expression -Command "E:\SC\Rightfax-Kiosk\AdHoc\Prod\BAI-OUT6\Task\_RunTF.PS1 -Credential $Cred"
...
./E:\sc\Rightfax-Kiosk\Set-ADAccountAdmin.ps1 -InputFile E:\SC\Rightfax-Kiosk\server-text-files\Prod\BAI-OUT6\Task\servers.txt -Trustee EFXBAI_STGOUT_ARK
./E:\sc\Rightfax-Kiosk\Set-ADAccountAdmin.ps1 -InputFile E:\SC\Rightfax-Kiosk\server-text-files\Prod\BAI-OUT6\Task\servers.txt -Trustee Rightfax_Ark
./E:\sc\Rightfax-Kiosk\Set-ADAccountAdmin.ps1 -InputFile E:\SC\Rightfax-Kiosk\server-text-files\Prod\BAI-OUT6\Task\servers.txt -Trustee OpsMgrAdmins_ARK
./E:\sc\Rightfax-Kiosk\Set-ADAccountAdmin.ps1 -InputFile E:\SC\Rightfax-Kiosk\server-text-files\Prod\BAI-OUT6\Task\servers.txt -Trustee IISADMINS
./E:\sc\Rightfax-Kiosk\Set-ADAccountUsers.ps1 -Inputfile E:\SC\Rightfax-Kiosk\server-text-files\Prod\BAI-OUT6\Task\servers.txt -Trustee Rightfax
