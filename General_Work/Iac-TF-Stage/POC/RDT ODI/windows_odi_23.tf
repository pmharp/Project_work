...
resource "optumvm_windowsvm" "windows_odi_23" {
...
output "windows_odi_23_servername" {
  value = "${optumvm_windowsvm.windows_odi_23.servername}"
}

output "windows_odi_23_ipaddress" {
  value = "${optumvm_windowsvm.windows_odi_23.ipaddress}"
}

output "windows_odi_23_image_used" {
  value = "${optumvm_windowsvm.windows_odi_23.image}"
}

output "windows_odi_23_cpu" {
  value = "${optumvm_windowsvm.windows_odi_23.cpu}"
}

output "windows_odi_23_memory" {
  value = "${optumvm_windowsvm.windows_odi_23.memory}"
}

output "windows_odi_23_targetenv" {
  value = "${optumvm_windowsvm.windows_odi_23.targetenv}"
}

output "windows_odi_23_datacenter" {
  value = "${optumvm_windowsvm.windows_odi_23.datacenter}"
}

output "windows_odi_23_networkzone" {
  value = "${optumvm_windowsvm.windows_odi_23.networkzone}"
}
