...
resource "optumvm_windowsvm" "windows_odi_1" {

  # OS Building -----------------------------------
  image = "v8-w2019"  # options are 'v8-w2019', 'v8-w2016'
  # -----------------------------------------------

  # Edited by builder: Can mod for Day 2 Actions
  cpu                = "8"        # Options are 1- 16
  memory             = "32"        # Options are 4 - 128 using EVEN and ODD numbers
  ...
  disk1sizegb     = "300"  # Disk 1 can be sized 10GB-4TB, Disks 2-8 can be sized 1GB-4TB
...
output "windows_odi_1_servername" {
  value = "${optumvm_windowsvm.windows_odi_1.servername}"
}

output "windows_odi_1_ipaddress" {
  value = "${optumvm_windowsvm.windows_odi_1.ipaddress}"
}

output "windows_odi_1_image_used" {
  value = "${optumvm_windowsvm.windows_odi_1.image}"
}

output "windows_odi_1_cpu" {
  value = "${optumvm_windowsvm.windows_odi_1.cpu}"
}

output "windows_odi_1_memory" {
  value = "${optumvm_windowsvm.windows_odi_1.memory}"
}

output "windows_odi_1_targetenv" {
  value = "${optumvm_windowsvm.windows_odi_1.targetenv}"
}

output "windows_odi_1_datacenter" {
  value = "${optumvm_windowsvm.windows_odi_1.datacenter}"
}

output "windows_odi_1_networkzone" {
  value = "${optumvm_windowsvm.windows_odi_1.networkzone}"
}