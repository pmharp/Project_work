resource "optumnas_resourcenas" "nas_nas_1"{
  ...
  admin_group               = "SED_ARK"   # name of the admin group, 40 members or less
  backup_required           = "False"   # true or false
  storage                   = "5"   # size in GB
  ...
  share_name                = "IAC_MNT"   # share name 
  client_mount_point        = "IAC_MNT_R"   # Linux Mount Point
