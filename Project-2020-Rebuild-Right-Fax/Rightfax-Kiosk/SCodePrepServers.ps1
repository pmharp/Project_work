...
$adminGroup.add("WinNT://MS/RightFax_Ark")  
  "$server`tSuccess"  
...
Write-Host -ForegroundColor Green "Setting System Environment Variables  Line 316" $Server 
 ...
 [System.Environment]::SetEnvironmentVariable('TEMP', 'E:\RFTemp',[System.EnvironmentVariableTarget]::User); [System.Environment]::SetEnvironmentVariable('TEMP', 'E:\RFTemp',[System.EnvironmentVariableTarget]::User)#End of Sets
}  
...
#moved to install
Write-Host -ForegroundColor Green "Prep Server 5 moved to installs "
}
