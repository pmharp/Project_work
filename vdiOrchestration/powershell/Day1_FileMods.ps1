...
$RSO_Array = @(
    ...
    ('Linux (Rhel7, Rhel8 and CentOS) vms to build - ODI: ' ,'linux_odi', 'Day1Work\Day1_InitialBuilds' ),
    ('Windows (2016 and 2019) vms to build - ODI: ' ,'windows_odi', 'Day1Work\Day1_InitialBuilds' ),
