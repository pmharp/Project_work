# -*- encoding: utf-8 -*-
# stub: knife-vsphere 4.1.3 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.homepage = "https://github.com/chef/knife-vsphere".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<rbvmomi>.freeze, [">= 1.8", "< 3.0"])
      s.add_runtime_dependency(%q<filesize>.freeze, [">= 0.1.1", "< 0.3.0"])
      ...
      s.add_dependency(%q<rbvmomi>.freeze, [">= 1.8", "< 3.0"])
      s.add_dependency(%q<filesize>.freeze, [">= 0.1.1", "< 0.3.0"])
