...
resource "optumvm_windowsvm" "windows_odi_1" {
  ...
  cpu                = "4"        # Options are 1- 16
  memory             = "8"        # Options are 4 - 128 using EVEN and ODD numbers
  ...
  disk1sizegb     = "200"  # Disk 1 can be sized 10GB-4TB, Disks 2-8 can be sized 1GB-4TB
