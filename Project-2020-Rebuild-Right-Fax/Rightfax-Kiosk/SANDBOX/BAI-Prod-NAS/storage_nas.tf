...
# # ----------------------------------------------------------------------------------------
 ...
 resource "optumstorage_nas" "storage_nas" {
   ...
   request_title             = "Right Fax NAS Prod" # title of the request
   owner_msid                = "kprice26" # MSID of the owner
   ask_app_name              = "Enterprise Fax" # name of the ask application, required nas_for_infra_or_app = true 
   admin_group               = "rightfax_ark" # name of the admin group, 40 members or less, owner_msid must be member
   storage                   = "500"     # size in GB. 1-5120 with backup, 1-15360GB w/o backup
   backup_required           = "true"    # Options are 'true', 'false'
   data_center               = "CTC"     # Options are 'CTC', 'ELR'
   environment_zone          = "PROD"   # Options are 'DEV', 'TEST', 'STAGE', 'PROD'
   ...
   share_name                = "BAI_Image_Prod" # share name 
