...
resource "optumvm_windowsvm" "windows_odi_20" {
...
output "windows_odi_20_servername" {
  value = "${optumvm_windowsvm.windows_odi_20.servername}"
}

output "windows_odi_20_ipaddress" {
  value = "${optumvm_windowsvm.windows_odi_20.ipaddress}"
}

output "windows_odi_20_image_used" {
  value = "${optumvm_windowsvm.windows_odi_20.image}"
}

output "windows_odi_20_cpu" {
  value = "${optumvm_windowsvm.windows_odi_20.cpu}"
}

output "windows_odi_20_memory" {
  value = "${optumvm_windowsvm.windows_odi_20.memory}"
}

output "windows_odi_20_targetenv" {
  value = "${optumvm_windowsvm.windows_odi_20.targetenv}"
}

output "windows_odi_20_datacenter" {
  value = "${optumvm_windowsvm.windows_odi_20.datacenter}"
}

output "windows_odi_20_networkzone" {
  value = "${optumvm_windowsvm.windows_odi_20.networkzone}"
}
