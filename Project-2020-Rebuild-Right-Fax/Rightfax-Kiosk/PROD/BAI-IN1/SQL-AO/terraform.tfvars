...
TFVAR_windows_app_reason = "Windows Web Svr" # Value displayed in tech.optum.com / odi_getvmdetails utility
...
TFVAR_windows_db_mssql_sa_cpu                    = "8"                    # DAY2_MOD: Options are 2-16, even values only
TFVAR_windows_db_mssql_sa_memory                 = "64"                    # DAY2_MOD: Range is 8-128 GB, even values only
...
TFVAR_windows_db_mssql_cls_dbcollation            = "Latin1_General_CI_AS" # Options: 
                                                                            # "Latin1_General_CI_AS", "SQL_Latin1_General_CP1_CI_AS", "Latin1_General_BIN", "Latin1_General_CI_AS_KS_WS"
                                                                            # "SQL_Latin1_General_CP1_CI_AI", "Latin1_General_CI_AI", "SQL_Latin1_General_CP1_CS_AS", "Latin1_General_BIN2"
TFVAR_windows_db_mssql_cls_sqlserverdatabasename  = "RFBlastIn1"                     # Lowercase Alphanumeric values with length 1-64
