...
resource "optumvm_windowsvm" "windows_odi_8" {
...
output "windows_odi_8_servername" {
  value = "${optumvm_windowsvm.windows_odi_8.servername}"
}

output "windows_odi_8_ipaddress" {
  value = "${optumvm_windowsvm.windows_odi_8.ipaddress}"
}

output "windows_odi_8_image_used" {
  value = "${optumvm_windowsvm.windows_odi_8.image}"
}

output "windows_odi_8_cpu" {
  value = "${optumvm_windowsvm.windows_odi_8.cpu}"
}

output "windows_odi_8_memory" {
  value = "${optumvm_windowsvm.windows_odi_8.memory}"
}

output "windows_odi_8_targetenv" {
  value = "${optumvm_windowsvm.windows_odi_8.targetenv}"
}

output "windows_odi_8_datacenter" {
  value = "${optumvm_windowsvm.windows_odi_8.datacenter}"
}

output "windows_odi_8_networkzone" {
  value = "${optumvm_windowsvm.windows_odi_8.networkzone}"
}
