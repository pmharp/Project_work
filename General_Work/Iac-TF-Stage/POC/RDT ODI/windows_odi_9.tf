...
resource "optumvm_windowsvm" "windows_odi_9" {
...
output "windows_odi_9_servername" {
  value = "${optumvm_windowsvm.windows_odi_9.servername}"
}

output "windows_odi_9_ipaddress" {
  value = "${optumvm_windowsvm.windows_odi_9.ipaddress}"
}

output "windows_odi_9_image_used" {
  value = "${optumvm_windowsvm.windows_odi_9.image}"
}

output "windows_odi_9_cpu" {
  value = "${optumvm_windowsvm.windows_odi_9.cpu}"
}

output "windows_odi_9_memory" {
  value = "${optumvm_windowsvm.windows_odi_9.memory}"
}

output "windows_odi_9_targetenv" {
  value = "${optumvm_windowsvm.windows_odi_9.targetenv}"
}

output "windows_odi_9_datacenter" {
  value = "${optumvm_windowsvm.windows_odi_9.datacenter}"
}

output "windows_odi_9_networkzone" {
  value = "${optumvm_windowsvm.windows_odi_9.networkzone}"
}
