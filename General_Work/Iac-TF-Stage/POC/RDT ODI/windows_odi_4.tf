...
resource "optumvm_windowsvm" "windows_odi_4" {
...
output "windows_odi_4_servername" {
  value = "${optumvm_windowsvm.windows_odi_4.servername}"
}

output "windows_odi_4_ipaddress" {
  value = "${optumvm_windowsvm.windows_odi_4.ipaddress}"
}

output "windows_odi_4_image_used" {
  value = "${optumvm_windowsvm.windows_odi_4.image}"
}

output "windows_odi_4_cpu" {
  value = "${optumvm_windowsvm.windows_odi_4.cpu}"
}

output "windows_odi_4_memory" {
  value = "${optumvm_windowsvm.windows_odi_4.memory}"
}

output "windows_odi_4_targetenv" {
  value = "${optumvm_windowsvm.windows_odi_4.targetenv}"
}

output "windows_odi_4_datacenter" {
  value = "${optumvm_windowsvm.windows_odi_4.datacenter}"
}

output "windows_odi_4_networkzone" {
  value = "${optumvm_windowsvm.windows_odi_4.networkzone}"
}
