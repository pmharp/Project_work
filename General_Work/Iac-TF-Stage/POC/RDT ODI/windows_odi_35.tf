...
resource "optumvm_windowsvm" "windows_odi_35" {
...
output "windows_odi_35_servername" {
  value = "${optumvm_windowsvm.windows_odi_35.servername}"
}

output "windows_odi_35_ipaddress" {
  value = "${optumvm_windowsvm.windows_odi_35.ipaddress}"
}

output "windows_odi_35_image_used" {
  value = "${optumvm_windowsvm.windows_odi_35.image}"
}

output "windows_odi_35_cpu" {
  value = "${optumvm_windowsvm.windows_odi_35.cpu}"
}

output "windows_odi_35_memory" {
  value = "${optumvm_windowsvm.windows_odi_35.memory}"
}

output "windows_odi_35_targetenv" {
  value = "${optumvm_windowsvm.windows_odi_35.targetenv}"
}

output "windows_odi_35_datacenter" {
  value = "${optumvm_windowsvm.windows_odi_35.datacenter}"
}

output "windows_odi_35_networkzone" {
  value = "${optumvm_windowsvm.windows_odi_35.networkzone}"
}
