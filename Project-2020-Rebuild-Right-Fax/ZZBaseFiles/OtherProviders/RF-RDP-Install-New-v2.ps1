...
Foreach ($file in $files) {  
    ...
    copy-Item $file.fullname ($destinationPath + $relativepath) -Exclude (Get-ChildItem -Path $SourcePath) 
...
*   Have installation files been Copied Files   * 
...
if ($addorchange -like "Install"){StartInstall($addorchange)} 
