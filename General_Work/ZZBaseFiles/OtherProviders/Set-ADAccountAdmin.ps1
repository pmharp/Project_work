...
.NOTES
Name: Set-ADAccountAdmin.ps1
Author: Patrick Harp

.EXAMPLE
.\Set-ADAccountAdmin.ps1 -Computer Server01 -Trustee test

Description:
Will set the test account as a Local Administrator on Server01

.EXAMPLE
.\Set-ADAccountAdmin.ps1 -Computer 'Server01,Server02' -Trustee Contoso\HRTest

Description:
Will set the HRTest group in the contoso domain as Local Administrators on Server01 and Server02

.EXAMPLE
.\Set-ADAccountAdmin.ps1 -InputFile C:\ListofComputers.txt -Trustee User01
