...
resource "optumvm_windowsvm" "windows_odi_36" {
...
output "windows_odi_36_servername" {
  value = "${optumvm_windowsvm.windows_odi_36.servername}"
}

output "windows_odi_36_ipaddress" {
  value = "${optumvm_windowsvm.windows_odi_36.ipaddress}"
}

output "windows_odi_36_image_used" {
  value = "${optumvm_windowsvm.windows_odi_36.image}"
}

output "windows_odi_36_cpu" {
  value = "${optumvm_windowsvm.windows_odi_36.cpu}"
}

output "windows_odi_36_memory" {
  value = "${optumvm_windowsvm.windows_odi_36.memory}"
}

output "windows_odi_36_targetenv" {
  value = "${optumvm_windowsvm.windows_odi_36.targetenv}"
}

output "windows_odi_36_datacenter" {
  value = "${optumvm_windowsvm.windows_odi_36.datacenter}"
}

output "windows_odi_36_networkzone" {
  value = "${optumvm_windowsvm.windows_odi_36.networkzone}"
}
