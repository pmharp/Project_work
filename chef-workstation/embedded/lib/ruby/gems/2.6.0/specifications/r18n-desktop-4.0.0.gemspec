# -*- encoding: utf-8 -*-
# stub: r18n-desktop 4.0.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.homepage = "https://github.com/r18n/r18n/tree/master/r18n-desktop".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<r18n-core>.freeze, ["= 4.0.0"])
    else
      s.add_dependency(%q<r18n-core>.freeze, ["= 4.0.0"])
    end
  else
    s.add_dependency(%q<r18n-core>.freeze, ["= 4.0.0"])
  end
