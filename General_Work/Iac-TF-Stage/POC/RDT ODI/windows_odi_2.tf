...
resource "optumvm_windowsvm" "windows_odi_2" {
...
output "windows_odi_2_servername" {
  value = "${optumvm_windowsvm.windows_odi_2.servername}"
}

output "windows_odi_2_ipaddress" {
  value = "${optumvm_windowsvm.windows_odi_2.ipaddress}"
}

output "windows_odi_2_image_used" {
  value = "${optumvm_windowsvm.windows_odi_2.image}"
}

output "windows_odi_2_cpu" {
  value = "${optumvm_windowsvm.windows_odi_2.cpu}"
}

output "windows_odi_2_memory" {
  value = "${optumvm_windowsvm.windows_odi_2.memory}"
}

output "windows_odi_2_targetenv" {
  value = "${optumvm_windowsvm.windows_odi_2.targetenv}"
}

output "windows_odi_2_datacenter" {
  value = "${optumvm_windowsvm.windows_odi_2.datacenter}"
}

output "windows_odi_2_networkzone" {
  value = "${optumvm_windowsvm.windows_odi_2.networkzone}"
}
