...
resource "optumvm_windowsvm" "windows_odi_10" {
...
output "windows_odi_10_servername" {
  value = "${optumvm_windowsvm.windows_odi_10.servername}"
}

output "windows_odi_10_ipaddress" {
  value = "${optumvm_windowsvm.windows_odi_10.ipaddress}"
}

output "windows_odi_10_image_used" {
  value = "${optumvm_windowsvm.windows_odi_10.image}"
}

output "windows_odi_10_cpu" {
  value = "${optumvm_windowsvm.windows_odi_10.cpu}"
}

output "windows_odi_10_memory" {
  value = "${optumvm_windowsvm.windows_odi_10.memory}"
}

output "windows_odi_10_targetenv" {
  value = "${optumvm_windowsvm.windows_odi_10.targetenv}"
}

output "windows_odi_10_datacenter" {
  value = "${optumvm_windowsvm.windows_odi_10.datacenter}"
}

output "windows_odi_10_networkzone" {
  value = "${optumvm_windowsvm.windows_odi_10.networkzone}"
}
