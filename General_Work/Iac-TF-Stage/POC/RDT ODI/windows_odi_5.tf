...
resource "optumvm_windowsvm" "windows_odi_5" {
...
output "windows_odi_5_servername" {
  value = "${optumvm_windowsvm.windows_odi_5.servername}"
}

output "windows_odi_5_ipaddress" {
  value = "${optumvm_windowsvm.windows_odi_5.ipaddress}"
}

output "windows_odi_5_image_used" {
  value = "${optumvm_windowsvm.windows_odi_5.image}"
}

output "windows_odi_5_cpu" {
  value = "${optumvm_windowsvm.windows_odi_5.cpu}"
}

output "windows_odi_5_memory" {
  value = "${optumvm_windowsvm.windows_odi_5.memory}"
}

output "windows_odi_5_targetenv" {
  value = "${optumvm_windowsvm.windows_odi_5.targetenv}"
}

output "windows_odi_5_datacenter" {
  value = "${optumvm_windowsvm.windows_odi_5.datacenter}"
}

output "windows_odi_5_networkzone" {
  value = "${optumvm_windowsvm.windows_odi_5.networkzone}"
}
