...
resource "optumvm_windowsvm" "windows_odi_27" {
...
output "windows_odi_27_servername" {
  value = "${optumvm_windowsvm.windows_odi_27.servername}"
}

output "windows_odi_27_ipaddress" {
  value = "${optumvm_windowsvm.windows_odi_27.ipaddress}"
}

output "windows_odi_27_image_used" {
  value = "${optumvm_windowsvm.windows_odi_27.image}"
}

output "windows_odi_27_cpu" {
  value = "${optumvm_windowsvm.windows_odi_27.cpu}"
}

output "windows_odi_27_memory" {
  value = "${optumvm_windowsvm.windows_odi_27.memory}"
}

output "windows_odi_27_targetenv" {
  value = "${optumvm_windowsvm.windows_odi_27.targetenv}"
}

output "windows_odi_27_datacenter" {
  value = "${optumvm_windowsvm.windows_odi_27.datacenter}"
}

output "windows_odi_27_networkzone" {
  value = "${optumvm_windowsvm.windows_odi_27.networkzone}"
}
