...
resource "optumvm_windowsvm" "windows_odi_12" {
...
output "windows_odi_12_servername" {
  value = "${optumvm_windowsvm.windows_odi_12.servername}"
}

output "windows_odi_12_ipaddress" {
  value = "${optumvm_windowsvm.windows_odi_12.ipaddress}"
}

output "windows_odi_12_image_used" {
  value = "${optumvm_windowsvm.windows_odi_12.image}"
}

output "windows_odi_12_cpu" {
  value = "${optumvm_windowsvm.windows_odi_12.cpu}"
}

output "windows_odi_12_memory" {
  value = "${optumvm_windowsvm.windows_odi_12.memory}"
}

output "windows_odi_12_targetenv" {
  value = "${optumvm_windowsvm.windows_odi_12.targetenv}"
}

output "windows_odi_12_datacenter" {
  value = "${optumvm_windowsvm.windows_odi_12.datacenter}"
}

output "windows_odi_12_networkzone" {
  value = "${optumvm_windowsvm.windows_odi_12.networkzone}"
}
