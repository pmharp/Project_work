...
resource "optumvm_windowsvm" "windows_odi_11" {
...
output "windows_odi_11_servername" {
  value = "${optumvm_windowsvm.windows_odi_11.servername}"
}

output "windows_odi_11_ipaddress" {
  value = "${optumvm_windowsvm.windows_odi_11.ipaddress}"
}

output "windows_odi_11_image_used" {
  value = "${optumvm_windowsvm.windows_odi_11.image}"
}

output "windows_odi_11_cpu" {
  value = "${optumvm_windowsvm.windows_odi_11.cpu}"
}

output "windows_odi_11_memory" {
  value = "${optumvm_windowsvm.windows_odi_11.memory}"
}

output "windows_odi_11_targetenv" {
  value = "${optumvm_windowsvm.windows_odi_11.targetenv}"
}

output "windows_odi_11_datacenter" {
  value = "${optumvm_windowsvm.windows_odi_11.datacenter}"
}

output "windows_odi_11_networkzone" {
  value = "${optumvm_windowsvm.windows_odi_11.networkzone}"
}
