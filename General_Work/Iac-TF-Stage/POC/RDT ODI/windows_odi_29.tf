...
resource "optumvm_windowsvm" "windows_odi_29" {
...
output "windows_odi_29_servername" {
  value = "${optumvm_windowsvm.windows_odi_29.servername}"
}

output "windows_odi_29_ipaddress" {
  value = "${optumvm_windowsvm.windows_odi_29.ipaddress}"
}

output "windows_odi_29_image_used" {
  value = "${optumvm_windowsvm.windows_odi_29.image}"
}

output "windows_odi_29_cpu" {
  value = "${optumvm_windowsvm.windows_odi_29.cpu}"
}

output "windows_odi_29_memory" {
  value = "${optumvm_windowsvm.windows_odi_29.memory}"
}

output "windows_odi_29_targetenv" {
  value = "${optumvm_windowsvm.windows_odi_29.targetenv}"
}

output "windows_odi_29_datacenter" {
  value = "${optumvm_windowsvm.windows_odi_29.datacenter}"
}

output "windows_odi_29_networkzone" {
  value = "${optumvm_windowsvm.windows_odi_29.networkzone}"
}
