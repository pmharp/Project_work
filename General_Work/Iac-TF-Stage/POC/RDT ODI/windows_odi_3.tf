...
resource "optumvm_windowsvm" "windows_odi_3" {
...
output "windows_odi_3_servername" {
  value = "${optumvm_windowsvm.windows_odi_3.servername}"
}

output "windows_odi_3_ipaddress" {
  value = "${optumvm_windowsvm.windows_odi_3.ipaddress}"
}

output "windows_odi_3_image_used" {
  value = "${optumvm_windowsvm.windows_odi_3.image}"
}

output "windows_odi_3_cpu" {
  value = "${optumvm_windowsvm.windows_odi_3.cpu}"
}

output "windows_odi_3_memory" {
  value = "${optumvm_windowsvm.windows_odi_3.memory}"
}

output "windows_odi_3_targetenv" {
  value = "${optumvm_windowsvm.windows_odi_3.targetenv}"
}

output "windows_odi_3_datacenter" {
  value = "${optumvm_windowsvm.windows_odi_3.datacenter}"
}

output "windows_odi_3_networkzone" {
  value = "${optumvm_windowsvm.windows_odi_3.networkzone}"
}
