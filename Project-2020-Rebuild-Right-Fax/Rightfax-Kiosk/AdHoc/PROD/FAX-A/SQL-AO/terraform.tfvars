...
# ------------------------------------------------------------------------------------------
TFVAR_odi_askid                = "UHGWM110-013393" # example UHGWM110-017540
TFVAR_odi_ppmoprojectnum       = "PRJ273631"         # Optional: If entered needs to be valid PRJ, and not OFE
TFVAR_odi_ppmoapplicationname  = "Enterprise FAX"    # Optional: If entered needs to be valid ASK PRJ NAME (EXACT text)
...
TFVAR_odi_drcode               = "DR-303"   # Options: 'NO-DR' and 'DR-303' is allowed if ASKID has DR designation
...
# ------------------------------------------------------------------------------------------
TFVAR_windows_db_mssql_cls_count                  = "1"                    # Number of Windows DB servers to build
TFVAR_windows_db_mssql_cls_cpu                    = "8"                    # DAY2_MOD: Options are 4-16, even values only
TFVAR_windows_db_mssql_cls_memory                 = "64"                   # DAY2_MOD: Range is 8-128 GB, even values only
...
TFVAR_windows_db_mssql_cls_dbcollation            = "Latin1_General_CI_AS" # Options: 
                                                                            # "Latin1_General_CI_AS", "SQL_Latin1_General_CP1_CI_AS", "Latin1_General_BIN", "Latin1_General_CI_AS_KS_WS"
                                                                            # "SQL_Latin1_General_CP1_CI_AI", "Latin1_General_CI_AI", "SQL_Latin1_General_CP1_CS_AS", "Latin1_General_BIN2"
TFVAR_windows_db_mssql_cls_sqlserverdatabasename  = " rfsqlproda1"           # Lowercase Alphanumeric values with length 1-64
