...
resource "optumvm_windowsvm" "windows_odi_15" {
...
output "windows_odi_15_servername" {
  value = "${optumvm_windowsvm.windows_odi_15.servername}"
}

output "windows_odi_15_ipaddress" {
  value = "${optumvm_windowsvm.windows_odi_15.ipaddress}"
}

output "windows_odi_15_image_used" {
  value = "${optumvm_windowsvm.windows_odi_15.image}"
}

output "windows_odi_15_cpu" {
  value = "${optumvm_windowsvm.windows_odi_15.cpu}"
}

output "windows_odi_15_memory" {
  value = "${optumvm_windowsvm.windows_odi_15.memory}"
}

output "windows_odi_15_targetenv" {
  value = "${optumvm_windowsvm.windows_odi_15.targetenv}"
}

output "windows_odi_15_datacenter" {
  value = "${optumvm_windowsvm.windows_odi_15.datacenter}"
}

output "windows_odi_15_networkzone" {
  value = "${optumvm_windowsvm.windows_odi_15.networkzone}"
}
