...
resource "optumvm_windowsvm" "windows_odi_28" {

  # OS Building -----------------------------------
  image = "v8-w2019"  # options are 'v8-w2016', 'v8-w2019'
  # -----------------------------------------------

  # Edited by builder: Can mod for Day 2 Actions
  cpu                = "4"        # Options are 1- 16
  memory             = "8"        # Options are 4- 128
...
output "windows_odi_28_servername" {
  value = "${optumvm_windowsvm.windows_odi_28.servername}"
}

output "windows_odi_28_ipaddress" {
  value = "${optumvm_windowsvm.windows_odi_28.ipaddress}"
}

output "windows_odi_28_image_used" {
  value = "${optumvm_windowsvm.windows_odi_28.image}"
}

output "windows_odi_28_cpu" {
  value = "${optumvm_windowsvm.windows_odi_28.cpu}"
}

output "windows_odi_28_memory" {
  value = "${optumvm_windowsvm.windows_odi_28.memory}"
}

output "windows_odi_28_targetenv" {
  value = "${optumvm_windowsvm.windows_odi_28.targetenv}"
}

output "windows_odi_28_datacenter" {
  value = "${optumvm_windowsvm.windows_odi_28.datacenter}"
}

output "windows_odi_28_networkzone" {
  value = "${optumvm_windowsvm.windows_odi_28.networkzone}"
}
