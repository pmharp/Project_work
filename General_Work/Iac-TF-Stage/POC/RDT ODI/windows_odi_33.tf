...
resource "optumvm_windowsvm" "windows_odi_33" {
...
output "windows_odi_33_servername" {
  value = "${optumvm_windowsvm.windows_odi_33.servername}"
}

output "windows_odi_33_ipaddress" {
  value = "${optumvm_windowsvm.windows_odi_33.ipaddress}"
}

output "windows_odi_33_image_used" {
  value = "${optumvm_windowsvm.windows_odi_33.image}"
}

output "windows_odi_33_cpu" {
  value = "${optumvm_windowsvm.windows_odi_33.cpu}"
}

output "windows_odi_33_memory" {
  value = "${optumvm_windowsvm.windows_odi_33.memory}"
}

output "windows_odi_33_targetenv" {
  value = "${optumvm_windowsvm.windows_odi_33.targetenv}"
}

output "windows_odi_33_datacenter" {
  value = "${optumvm_windowsvm.windows_odi_33.datacenter}"
}

output "windows_odi_33_networkzone" {
  value = "${optumvm_windowsvm.windows_odi_33.networkzone}"
}
