...
resource "optumvm_windowsvm" "windows_odi_14" {
...
output "windows_odi_14_servername" {
  value = "${optumvm_windowsvm.windows_odi_14.servername}"
}

output "windows_odi_14_ipaddress" {
  value = "${optumvm_windowsvm.windows_odi_14.ipaddress}"
}

output "windows_odi_14_image_used" {
  value = "${optumvm_windowsvm.windows_odi_14.image}"
}

output "windows_odi_14_cpu" {
  value = "${optumvm_windowsvm.windows_odi_14.cpu}"
}

output "windows_odi_14_memory" {
  value = "${optumvm_windowsvm.windows_odi_14.memory}"
}

output "windows_odi_14_targetenv" {
  value = "${optumvm_windowsvm.windows_odi_14.targetenv}"
}

output "windows_odi_14_datacenter" {
  value = "${optumvm_windowsvm.windows_odi_14.datacenter}"
}

output "windows_odi_14_networkzone" {
  value = "${optumvm_windowsvm.windows_odi_14.networkzone}"
}
