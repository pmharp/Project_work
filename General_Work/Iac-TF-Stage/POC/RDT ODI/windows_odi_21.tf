...
resource "optumvm_windowsvm" "windows_odi_21" {
...
output "windows_odi_21_servername" {
  value = "${optumvm_windowsvm.windows_odi_21.servername}"
}

output "windows_odi_21_ipaddress" {
  value = "${optumvm_windowsvm.windows_odi_21.ipaddress}"
}

output "windows_odi_21_image_used" {
  value = "${optumvm_windowsvm.windows_odi_21.image}"
}

output "windows_odi_21_cpu" {
  value = "${optumvm_windowsvm.windows_odi_21.cpu}"
}

output "windows_odi_21_memory" {
  value = "${optumvm_windowsvm.windows_odi_21.memory}"
}

output "windows_odi_21_targetenv" {
  value = "${optumvm_windowsvm.windows_odi_21.targetenv}"
}

output "windows_odi_21_datacenter" {
  value = "${optumvm_windowsvm.windows_odi_21.datacenter}"
}

output "windows_odi_21_networkzone" {
  value = "${optumvm_windowsvm.windows_odi_21.networkzone}"
}
