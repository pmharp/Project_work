...
# Change "optumvm_win2016fsvm" to "optumvm_win2016ssvm" in row 4
# Do FIND on "win2016_fs_" and REPLACE with "win2016_ss_" b 11 occurances)
resource "optumvm_win2016fsvm" "win2016_fs_0" {
...
output "win2016_fs_0_servername" {
  value = "${optumvm_win2016fsvm.win2016_fs_0.servername}"
}

output "win2016_fs_0_ipaddress" {
  value = "${optumvm_win2016fsvm.win2016_fs_0.ipaddress}"
}
output "win2016_fs_0_cpu" {
  value = "${optumvm_win2016fsvm.win2016_fs_0.cpu}"
}

output "win2016_fs_0_memory" {
  value = "${optumvm_win2016fsvm.win2016_fs_0.memory}"
}

output "win2016_fs_0_targetenv" {
  value = "${optumvm_win2016fsvm.win2016_fs_0.targetenv}"
}