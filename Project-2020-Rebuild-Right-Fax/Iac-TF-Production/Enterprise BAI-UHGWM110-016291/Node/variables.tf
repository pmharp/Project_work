...
variable "TFVAR_cpu" { default = "" }
variable "TFVAR_memory" { default = "" }
variable "TFVAR_disks" { default = "" }
variable "TFVAR_servertype" { default = "" }
...
variable "TFVAR_vraenv"  { default ="prod" }
