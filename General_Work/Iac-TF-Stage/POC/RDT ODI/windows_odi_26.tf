...
resource "optumvm_windowsvm" "windows_odi_26" {
...
output "windows_odi_26_servername" {
  value = "${optumvm_windowsvm.windows_odi_26.servername}"
}

output "windows_odi_26_ipaddress" {
  value = "${optumvm_windowsvm.windows_odi_26.ipaddress}"
}

output "windows_odi_26_image_used" {
  value = "${optumvm_windowsvm.windows_odi_26.image}"
}

output "windows_odi_26_cpu" {
  value = "${optumvm_windowsvm.windows_odi_26.cpu}"
}

output "windows_odi_26_memory" {
  value = "${optumvm_windowsvm.windows_odi_26.memory}"
}

output "windows_odi_26_targetenv" {
  value = "${optumvm_windowsvm.windows_odi_26.targetenv}"
}

output "windows_odi_26_datacenter" {
  value = "${optumvm_windowsvm.windows_odi_26.datacenter}"
}

output "windows_odi_26_networkzone" {
  value = "${optumvm_windowsvm.windows_odi_26.networkzone}"
}
