...
resource "optumvm_windowsvm" "windows_odi_32" {
...
output "windows_odi_32_servername" {
  value = "${optumvm_windowsvm.windows_odi_32.servername}"
}

output "windows_odi_32_ipaddress" {
  value = "${optumvm_windowsvm.windows_odi_32.ipaddress}"
}

output "windows_odi_32_image_used" {
  value = "${optumvm_windowsvm.windows_odi_32.image}"
}

output "windows_odi_32_cpu" {
  value = "${optumvm_windowsvm.windows_odi_32.cpu}"
}

output "windows_odi_32_memory" {
  value = "${optumvm_windowsvm.windows_odi_32.memory}"
}

output "windows_odi_32_targetenv" {
  value = "${optumvm_windowsvm.windows_odi_32.targetenv}"
}

output "windows_odi_32_datacenter" {
  value = "${optumvm_windowsvm.windows_odi_32.datacenter}"
}

output "windows_odi_32_networkzone" {
  value = "${optumvm_windowsvm.windows_odi_32.networkzone}"
}
