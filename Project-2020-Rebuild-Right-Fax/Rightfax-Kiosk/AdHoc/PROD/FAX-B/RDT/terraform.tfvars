...
# Windows App Layer
# ------------------------------------------------------------------------------------------
#TFVAR_windows_app_count  = "19"               # Number of Windows APP servers to build
...
TFVAR_windows_app_reason = "Windows RDT Svr" # Value displayed in tech.optum.com / odi_getvmdetails utility
