...
resource "optumvm_windowsvm" "windows_odi_34" {
...
output "windows_odi_34_servername" {
  value = "${optumvm_windowsvm.windows_odi_34.servername}"
}

output "windows_odi_34_ipaddress" {
  value = "${optumvm_windowsvm.windows_odi_34.ipaddress}"
}

output "windows_odi_34_image_used" {
  value = "${optumvm_windowsvm.windows_odi_34.image}"
}

output "windows_odi_34_cpu" {
  value = "${optumvm_windowsvm.windows_odi_34.cpu}"
}

output "windows_odi_34_memory" {
  value = "${optumvm_windowsvm.windows_odi_34.memory}"
}

output "windows_odi_34_targetenv" {
  value = "${optumvm_windowsvm.windows_odi_34.targetenv}"
}

output "windows_odi_34_datacenter" {
  value = "${optumvm_windowsvm.windows_odi_34.datacenter}"
}

output "windows_odi_34_networkzone" {
  value = "${optumvm_windowsvm.windows_odi_34.networkzone}"
}
