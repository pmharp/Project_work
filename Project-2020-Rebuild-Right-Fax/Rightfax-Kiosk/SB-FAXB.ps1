...
function RDTIN1{
    ...
    clear-host
    Invoke-expression -Command "E:\SC\Rightfax-Kiosk\Sandbox\FAX-B\RDT\BAIRDTIN.PS1 -Credential $Cred"
    Start_Menu($select)
}
...
function TaskIN1{
    ...
    clear-host
    Invoke-expression -Command "E:\SC\Rightfax-Kiosk\Sandbox\FAX-B\Task\BAITASKIN.PS1 -Credential $Cred"
    Start_Menu($select)
}
