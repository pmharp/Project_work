...
#Starting Function PrepServer 2 
...
#Starting Function PrepServer 4
...
#Starting Function Display RDT to App Server
...
#Starting Function Read RDT XML with nested Functions
Function ReadRDTXML{ 
    ...
    #Starting Function Break RDP GT
    function BreakRDPGT{ 
        ReadApp($select) 
    } 
    ReadApp($select)       
...
#Starting Function Write RDT XML
...
#End Function Write RDT XML
}

#Start Function Set RDP2
Function SetRDP2{
...
#End of Read App 2 Function 
}
    
#Start Function Set-AutoLogon
...
#Starting Function Server LogOn
...
#Starting Function Script Cleanup
function Cleanup{
...
#Starting Function Install Process
...
#Starting Function Install Cleanup
...
#Start Function Start the Process
...
#End of Start the Process Function
}
...
function Start_Menu{
    ...
    *************************************************'
    ...
    if ($addorchange -like "Collect"){Copy_Check($addorchange)}
#End of the Main Menu Function    
}

#Start Function Collect
Function Start_Collect{
    ...
    *************************************************'
    ...
    Start_Menu($select)
#End of the Collect Function     
}

#Starting Function File Copy
function Start_FileCopy{  
    ...
    ************************************************* 
    ...
    $addorchange = Read-Host -Prompt 'Enter Choice' 
    if ($addorchange -like "ENT"){ENTIRE($addorchange)}     
    $addorchange = Read-Host -Prompt 'Enter Choice' 
    if ($addorchange -like "APP"){APP($addorchange)} 
    $addorchange = Read-Host -Prompt 'Enter Choice' 
    if ($addorchange -like "TYP"){TYP($addorchange)}     
    $addorchange = Read-Host -Prompt 'Enter Choice' 
    if ($addorchange -like "RDT"){RDT($addorchange)}     
    $addorchange = Read-Host -Prompt 'Enter Choice' 
    if ($addorchange -like "WEB"){WEB($addorchange)} 
#End of StartFileCopy Function    
}  
        
#Starting Function Install Prep
...
Function Copy_Check{ 
    ...
    *                                               *
    *   Type Next to Continue with Collect          * 
    *                                               *
