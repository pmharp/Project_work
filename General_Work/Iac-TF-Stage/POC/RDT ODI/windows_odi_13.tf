...
resource "optumvm_windowsvm" "windows_odi_13" {
...
output "windows_odi_13_servername" {
  value = "${optumvm_windowsvm.windows_odi_13.servername}"
}

output "windows_odi_13_ipaddress" {
  value = "${optumvm_windowsvm.windows_odi_13.ipaddress}"
}

output "windows_odi_13_image_used" {
  value = "${optumvm_windowsvm.windows_odi_13.image}"
}

output "windows_odi_13_cpu" {
  value = "${optumvm_windowsvm.windows_odi_13.cpu}"
}

output "windows_odi_13_memory" {
  value = "${optumvm_windowsvm.windows_odi_13.memory}"
}

output "windows_odi_13_targetenv" {
  value = "${optumvm_windowsvm.windows_odi_13.targetenv}"
}

output "windows_odi_13_datacenter" {
  value = "${optumvm_windowsvm.windows_odi_13.datacenter}"
}

output "windows_odi_13_networkzone" {
  value = "${optumvm_windowsvm.windows_odi_13.networkzone}"
}
