...
#   # Edited by builder: ALL DB Specific Items
  lobname                  = "LOB Internal DO_NOT_USE"      
  sqlserverdbversion       = "2016"                                      
  dbcollation              = "Latin1_General_CI_AS"
  sqlserverdatabasename    = "TestDB"
  databasesize             = "20"
  sqlserverdatabaseowner   = "pharp101"
  dbaccessgroup            = "sed_ark"
  phi                      = "No"                                         
  pii                      = "No"                                         
