# -*- encoding: utf-8 -*-
# stub: win32-mutex 0.4.3 ruby lib

Gem::Specification.new do |s|
  s.name = "win32-mutex".freeze
  s.version = "0.4.3"
  ...
  s.homepage = "https://github.com/djberg96/win32-mutex".freeze
  s.licenses = ["Artistic 2.0".freeze]
  s.required_ruby_version = Gem::Requirement.new("> 1.9.0".freeze)
  s.rubygems_version = "3.0.3".freeze
  s.summary = "Interface to MS Windows Mutex objects.".freeze
