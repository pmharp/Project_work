# -*- encoding: utf-8 -*-
# stub: chef-apply 0.4.15 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<mixlib-config>.freeze, [">= 3.0.5"])
      ...
      s.add_runtime_dependency(%q<train-winrm>.freeze, [">= 0"])
      ...
      s.add_runtime_dependency(%q<chef-cli>.freeze, [">= 1.0.3"])
      s.add_runtime_dependency(%q<chef-telemetry>.freeze, [">= 1.0.2"])
      s.add_runtime_dependency(%q<license-acceptance>.freeze, ["~> 1.0", ">= 1.0.11"])
      s.add_development_dependency(%q<bundler>.freeze, [">= 0"])
    else
      s.add_dependency(%q<mixlib-cli>.freeze, [">= 0"])
      s.add_dependency(%q<mixlib-config>.freeze, [">= 3.0.5"])
      ...
      s.add_dependency(%q<train-winrm>.freeze, [">= 0"])
      s.add_dependency(%q<pastel>.freeze, [">= 0"])
      s.add_dependency(%q<tty-spinner>.freeze, [">= 0"])
      s.add_dependency(%q<chef>.freeze, [">= 15.0"])
      s.add_dependency(%q<chef-cli>.freeze, [">= 1.0.3"])
      s.add_dependency(%q<chef-telemetry>.freeze, [">= 1.0.2"])
