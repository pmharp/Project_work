...
resource "optumvm_windowsvm" "windows_odi_18" {
...
output "windows_odi_18_servername" {
  value = "${optumvm_windowsvm.windows_odi_18.servername}"
}

output "windows_odi_18_ipaddress" {
  value = "${optumvm_windowsvm.windows_odi_18.ipaddress}"
}

output "windows_odi_18_image_used" {
  value = "${optumvm_windowsvm.windows_odi_18.image}"
}

output "windows_odi_18_cpu" {
  value = "${optumvm_windowsvm.windows_odi_18.cpu}"
}

output "windows_odi_18_memory" {
  value = "${optumvm_windowsvm.windows_odi_18.memory}"
}

output "windows_odi_18_targetenv" {
  value = "${optumvm_windowsvm.windows_odi_18.targetenv}"
}

output "windows_odi_18_datacenter" {
  value = "${optumvm_windowsvm.windows_odi_18.datacenter}"
}

output "windows_odi_18_networkzone" {
  value = "${optumvm_windowsvm.windows_odi_18.networkzone}"
}
