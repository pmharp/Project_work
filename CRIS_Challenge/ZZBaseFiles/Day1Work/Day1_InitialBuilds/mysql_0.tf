resource "optumvm_mysqlvm" "mysql_0" {
...
output "mysql_0_servername" {
  value = "${optumvm_mysqlvm.mysql_0.servername}"
}
output "mysql_0_ipaddress" {
  value = "${optumvm_mysqlvm.mysql_0.ipaddress}"
}
output "mysql_0_cpu" {
  value = "${optumvm_mysqlvm.mysql_0.cpu}"
}
output "mysql_0_memory" {
  value = "${optumvm_mysqlvm.mysql_0.memory}"
}
output "mysql_0_targetenv" {
  value = "${optumvm_mysqlvm.mysql_0.targetenv}"
}